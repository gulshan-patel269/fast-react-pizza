...
export async function action({ request }) {
  ...
  // if everythings is okay, create new order and redirect.
  const newOrder = await createOrder(order);

  // before going to order page, clear the cart once order is done.
  // use this trick, but not always. It cause performance issues
